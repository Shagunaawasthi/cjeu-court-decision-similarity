...
if os.path.exists(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_256_15_e10.model")):
    print(" loading model from file...")
    fname_256_15 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_256_15_e10.model"))
    model_256_15 = Doc2Vec.load(fname_256_15)
    print(" successfully loaded model!")
else:
    print(" training model...")
    model_256_15 = Doc2Vec(documents, vector_size=256, window=15, min_count=1, workers=4)
    model_256_15.train(documents, total_examples=model_256_15.corpus_count,epochs=10)
...
print()
print("* Vector size 256")
if os.path.exists(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_256_20_e10.model")):
    print(" loading model from file...")
    fname_256_20 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_256_20_e10.model"))
    model_256_20 = Doc2Vec.load(fname_256_20)
    print(" successfully loaded model!")
else:
    print(" training model...")
    model_256_20 = Doc2Vec(documents, vector_size=256, window=20, min_count=1, workers=4)
    model_256_20.train(documents, total_examples=model_256_20.corpus_count,epochs=10)
    print(" successfully trained model!")
    print(" saving model to file...")
    fname_256_20 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_256_20_e10.model"))
...
if os.path.exists(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_300_15_e10.model")):
    print(" loading model from file...")
    fname_300_15 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_300_15_e10.model"))
    model_300_15 = Doc2Vec.load(fname_300_15)
    print(" successfully loaded model!")
else:
    print(" training model...")
    model_300_15 = Doc2Vec(documents, vector_size=300, window=15, min_count=1, workers=4)
    model_300_15.train(documents, total_examples=model_300_15.corpus_count,epochs=10)
    print(" successfully trained model!")
    print(" saving model to file...")
    fname_300_15 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_300_15_e10.model"))
...
print()
print("* Vector size 300")
if os.path.exists(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_300_20_e10.model")):
    print(" loading model from file...")
    fname_300_20 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_300_20_e10.model"))
    model_300_20 = Doc2Vec.load(fname_300_20)
    print(" successfully loaded model!")
else:
    print(" training model...")
    model_300_20 = Doc2Vec(documents, vector_size=300, window=20, min_count=1, workers=4)
    model_300_20.train(documents, total_examples=model_300_20.corpus_count,epochs=10)
    print(" successfully trained model!")
    print(" saving model to file...")
    fname_300_20 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_300_20_e10.model"))
...
if os.path.exists(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_512_15_e10.model")):
    print(" loading model from file...")
    fname_512_15 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_512_15_e10.model"))
    model_512_15 = Doc2Vec.load(fname_512_15)
    print(" successfully loaded model!")
else:
    print(" training model...")
    model_512_15 = Doc2Vec(documents, vector_size=512, window=15, min_count=1, workers=4)
    model_512_15.train(documents, total_examples=model_512_15.corpus_count,epochs=10)
    print(" successfully trained model!")
    print(" saving model to file...")
    fname_512_15 = get_tmpfile(os.path.join(os.path.join(os.path.realpath('..'), "script_resources"), "doc2vec_512_15_e10.model"))
