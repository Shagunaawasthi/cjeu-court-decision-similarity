...
print("Word2Vec + Cosine document similarity analyser")
print("-----------------------------------------------")
print()
...
print("* Loading / training Word2Vec+Cosine model...")
...
sim = MatrixSimilarity(model_256[datafortraining], num_features=548704, num_best=20)
...
if os.path.exists('../outputdata/results_w2v_cosine.csv') == False:
